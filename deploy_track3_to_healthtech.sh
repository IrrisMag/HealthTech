...
# 🚀 Deploy Track 3 Backend to Existing HealthTech Railway Project
# AI-Enhanced Blood Bank System - Add to existing project
...
echo -e "${BLUE}🚀 DEPLOYING TRACK 3 TO EXISTING HEALTHTECH PROJECT${NC}"
echo -e "${BLUE}=================================================${NC}"
echo ""
...
echo ""
echo -e "${YELLOW}🔗 Connecting to existing HealthTech project...${NC}"

# Try to link to existing project
railway link

echo -e "${GREEN}✅ Connected to HealthTech project${NC}"
echo ""

# Navigate to Track 3 backend directory
TRACK3_DIR="track3-backend"
if [ ! -d "$TRACK3_DIR" ]; then
    echo -e "${YELLOW}Creating Track 3 backend structure...${NC}"
    mkdir -p $TRACK3_DIR
    cd $TRACK3_DIR
else
    cd $TRACK3_DIR
...
echo -e "${YELLOW}🛠️  Creating Track 3 service configuration...${NC}"
...
# Create main.py - Optimized Track 3 Backend
cat > main.py << 'EOF'
"""
Track 3: AI-Enhanced Blood Bank Stock Monitoring and Forecasting System
Optimized Backend for Railway Deployment
"""
...
MONGODB_URL = os.getenv("MONGODB_URL", "mongodb+srv://healthtech:healthtech2024@cluster0.mongodb.net/healthtech_track3?retryWrites=true&w=majority")
...
async def lifespan(app: FastAPI):
    # Startup
    global db_client, database, db_manager, dhis2_manager, forecasting_engine
...
async def root():
    return {
        ...
        "status": "operational",
        "version": "1.0.0",
        "deployment": "Railway HealthTech Project",
        "features": [
...
echo -e "${GREEN}✅ Track 3 backend files created${NC}"

# Set environment variables for the new service
echo -e "${YELLOW}🔧 Setting environment variables for Track 3 service...${NC}"
...
railway variables --set "MONGODB_URL=mongodb+srv://healthtech:healthtech2024@cluster0.mongodb.net/healthtech_track3?retryWrites=true&w=majority" \
                  --set "DATABASE_NAME=healthtech_track3" \
                  --set "DHIS2_BASE_URL=https://play.im.dhis2.org/stable-2-42-1" \
                  --set "DHIS2_USERNAME=admin" \
                  --set "DHIS2_PASSWORD=district" \
                  --set "PORT=8000" \
                  --set "PYTHONPATH=/app"
...
git add .
git commit -m "Track 3 AI-Enhanced Blood Bank Backend - Railway Deployment"

# Deploy to Railway
echo -e "${YELLOW}🚀 Deploying Track 3 backend to HealthTech project...${NC}"
...
echo ""
echo -e "${GREEN}🎉 TRACK 3 BACKEND DEPLOYED TO HEALTHTECH PROJECT!${NC}"
echo ""
echo -e "${BLUE}📋 DEPLOYMENT SUMMARY:${NC}"
echo -e "${BLUE}=====================${NC}"
echo -e "🏥 Project: HealthTech (Existing)"
echo -e "🩸 Service: Track 3 AI-Enhanced Blood Bank Backend"
echo -e "🗄️  Database: MongoDB Atlas (healthtech_track3)"
echo -e "🌐 DHIS2: https://play.im.dhis2.org/stable-2-42-1"
echo -e "🤖 AI Features: ARIMA Forecasting, Optimization"
echo -e "📊 Real-time: Live inventory, donor management, requests"
echo ""
echo -e "${BLUE}🔍 KEY ENDPOINTS:${NC}"
echo -e "• Health Check: /health"
echo -e "• DHIS2 Test: /dhis2/test"
echo -e "• Donors: /donors"
echo -e "• Inventory: /inventory"
echo -e "• Requests: /requests"
echo -e "• Forecasting: /forecast/{blood_type}"
echo -e "• Analytics: /analytics/performance"
echo ""
echo -e "${GREEN}✅ Track 3 backend is now part of the HealthTech project!${NC}"
echo ""
echo -e "${BLUE}🎯 TRACK 3 FEATURES DEPLOYED:${NC}"
echo -e "✅ Real-time blood inventory management"
echo -e "✅ AI-powered demand forecasting (ARIMA)"
echo -e "✅ DHIS2 integration with live connection"
echo -e "✅ Complete donor management system"
echo -e "✅ Blood request tracking and fulfillment"
echo -e "✅ Performance analytics and reporting"
echo -e "✅ MongoDB database with real data operations"
echo ""
echo -e "${YELLOW}📝 NEXT STEPS:${NC}"
echo -e "1. Check Railway dashboard for service URL"
echo -e "2. Update frontend environment variables"
echo -e "3. Test all API endpoints"
echo -e "4. Verify DHIS2 connection"
echo ""
echo -e "${GREEN}🚀 Track 3 backend deployment to HealthTech complete!${NC}"
