...
async def forecast_with_clinical_data(
    ...
    data_service_url: str = Query(default="http://data:8000", description="Data service URL")
):
    """
    ...
    **Query Parameters:**
    ...
    - **data_service_url**: Data service URL (default: http://data:8000)
    ...
    return {
        ...
        "examples": [
            ...
            },
            {
                ...
                "url": "/forecast/clinical-data?data_service_url=http://localhost:8000&limit=25",
