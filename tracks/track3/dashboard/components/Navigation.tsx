...
const navigation = [
  ...
  { name: 'Inventory', href: '/inventory', icon: TestTube },
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
            ...
            <div className="relative">
              <button className="flex items-center space-x-2 p-2 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded-lg">
        ...
        <div className="sm:hidden">
          ...
          <div className="pt-4 pb-3 border-t border-gray-200">
            <div className="flex items-center px-4">
              ...
              <div className="ml-3">
                <div className="text-base font-medium text-gray-800">Dr. Admin</div>
                <div className="text-sm text-gray-500">admin@dgh.cm</div>
              </div>
